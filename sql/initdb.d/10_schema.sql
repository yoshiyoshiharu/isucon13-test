...
CREATE INDEX idx_reservation_slots_start_at_and_end_at ON reservation_slots(`start_at`, `end_at`);
...
CREATE INDEX idx_ng_words_user_id_and_livestream_id ON ng_words(`user_id`, `livestream_id`);
